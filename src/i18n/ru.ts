...
export const i18n: Ii18n = {
    attributes: {
        ...
        battleAttribute: {
            ...
            evasionChance: "шанс уклонения",
            hpRegen: "регенерация",
            magicPower: "магическая сила",
            maxHp: "здоровье",
            physicalPower: "физичекая сила",
            customNumber: "какоето число",
            hp: "текущее здоровье",
        },
        ...
        bonusType: {
            ...
            CRIT_ACCUM_IF_NOT: "Увеличивает шансы крита\nна {1}{2} при\nотсутствии крита",
            CRIT_INCREASE: "Увеличивает урон крит.\nатак на {1}{2}",
            NONCRIT_INCREASE: "Увеличивает урон не крит.\nатак на {1}{2}",
            CRIT_WITH_MAGIC: "Магические атакующие\nнавыки могут быть\nкритическими",
            HEAL_INCREASE: "Увеливает лечение на {1}{2}",
            INCREASE_DAMAGE_TO_ARMOR: "Увеливает урон\nпо броне на {1}{2}",
            INCREASE_DAMAGE_TO_TARGET_WITH_STATUS: "Увеливает урон по\nцелям с {3}\nна {1}{2}",
            ...
            INCREASE_TOTAL_DAMAGE: "Увеливает весь урон\nна {1}%{2}",
            INCREASE_ARMOR_GAIN: "Увеличивает получаемую\nброню на {1}{2}",
            STATUS_APPLY_INCREASE: "Увеливает накладываемый\n{3} на {1}{2}",
            SUMMON_INCREASE_DAMAGE: "Увеливает урон призыва\nна {1}{2}",
            TOTEM_INCREASE_VALUE: "Увеливает силу тотема\nна {1}{2}",
            CAST_SKILL_X_ROUND: "Раз за бой, срабатывает\nэффект\nв конце раунда",
            UNPACK_SKILL_IN_STASH: "Переместите предмет в\nинвентаре чтобы получить\nнавык",
            CRIT_WITH_HEAL: "Лечащие навыки могут быть\nкритическими",
            CRIT_WITH_PHYSICAL: "Физические атакующие\nнавыки могут быть\nкритическими",
            INCREASE_BUFF_POTENCY: "Увеличивает числа усилений\nна {1}{2}",
            INCREASE_DEBUFF_POTENCY: "Увеличивает числа проклятий\nна {1}{2}",
        },
