export const SKILLS_EN = {
    ...
    mc: {
        ...
        battleMageSkill: {
            name: "Multi attack",
            desc1: "Attack random enemy with\nphysical damage [1+35%xPP]\n1/3 of basic attack becomes\nPP and 1/3 becomes MP for\n2 turns; Make magic attacks\nfor [1+35%xMP] instead of\nregular basic attacks",
            desc2: "Attack random enemy with\nphysical damage [1+50%xPP]\n1/3 of basic attack becomes\nPP and 1/3 becomes MP for\n2 turns; Make magic attacks\nfor [1+50%xMP] instead of\nregular basic attacks",
            desc3: "Attack random enemy with\nphysical damage [1+65%xPP]\n1/3 of basic attack becomes\nPP and 1/3 becomes MP for\n2 turns; Make magic attacks\nfor [1+65%xMP] instead of\nregular basic attacks",
        },
        beastMasterSkill: {
    ...
    mobs: {
        ...
        spiritTeamFlurry: {
            name: "Pointy sticks",
            desc1: `Unleash [35%xPP]+ number\nof teammates damage 1\nattacks. And if alone\npowerful attack on two\nenemies`,
            desc2: `Unleash [50%xPP]+ number\nof teammates damage 1\nattacks. And if alone\npowerful attack on two\nenemies`,
            desc3: `Unleash [65%xPP]+ number\nof teammates damage 1\nattacks. And if alone\npowerful attack on two\nenemies`,
        },
        spiritTeamRevenge: {
            name: "Revenge poke",
            desc1: "Forget basic attack to\nstrike next enemy that\nuses basic attack and\napply [1+35%xPP] bleed",
            desc2: "Forget basic attack to\nstrike next enemy that\nuses basic attack and\napply [1+65%xPP] bleed",
            desc3: "Forget basic attack to\nstrike next enemy that\nuses basic attack and\napply [1+PP] bleed",
        },
        pirateDeadmansCurse: {
            name: "Deadmans curse",
        ...
        pirateCallTheCannons: {
            name: "Call cannons",
            desc1: "Deal [4] physical damage\nand apply [2] burn and\nbleed to all enemies",
            desc2: "Deal [6] physical damage\nand apply [2] burn and\nbleed to all enemies",
            desc3: "Deal [8] physical damage\nand apply [3] burn and\nbleed to all enemies",
        },
    },
};
