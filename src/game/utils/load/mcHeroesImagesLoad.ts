...
export function loadMcHeroesImages(scene: Scene) {
    ...
    scene.load.spritesheet(IMAGE_ASSASSIN_BATTLE_IDLE, "assets/sprites/units/mc/assassin/assassin_battle_idle_cut_400_8bit.png", {
        frameWidth: 400,
        frameHeight: 400,
    });

    scene.load.spritesheet(IMAGE_ASSASSIN_ATTACK, "assets/sprites/units/mc/assassin/assassin_attack_cut_400_8bit.png", {
        frameWidth: 400,
        frameHeight: 400,
    });
    ...
    scene.load.spritesheet(IMAGE_BATTLEMAGE_IDLE, "assets/sprites/units/mc/battlemage/battle_mage_idle_cut_300.png", {
        frameWidth: 300,
        frameHeight: 300,
    });
    ...
    //scene.load.image(IMAGE_BLADEDANCER, "assets/sprites/units/mc/bladedancer/bladedancer_2_400.png");
    ...
    scene.load.spritesheet(IMAGE_COMMANDER_IDLE, "assets/sprites/units/mc/commander/commander_idle_cut_350.png", {
        frameWidth: 350,
        frameHeight: 350,
    });
    ...
    //scene.load.image(IMAGE_HUNTER, "assets/sprites/units/mc/hunter/hunter_2_idle_300.png");
    ...
    scene.load.spritesheet(IMAGE_HUNTER_BATTLE_IDLE, "assets/sprites/units/mc/hunter/hunter_battle_idle_cut_400.png", {
        frameWidth: 400,
        frameHeight: 400,
    });

    scene.load.spritesheet(IMAGE_HUNTER_ATTACK, "assets/sprites/units/mc/hunter/hunter_attack_cut_400.png", {
        frameWidth: 400,
        frameHeight: 400,
    });
    ...
    scene.load.spritesheet(IMAGE_JESTER_IDLE, "assets/sprites/units/mc/jester/jester_idle_cut_300.png", {
        frameWidth: 300,
        frameHeight: 300,
    });

    scene.load.spritesheet(IMAGE_JESTER_BATTLE_IDLE, "assets/sprites/units/mc/jester/jester_battle_idle_cut_400.png", {
        frameWidth: 400,
        frameHeight: 400,
    });

    scene.load.spritesheet(IMAGE_JESTER_ATTACK, "assets/sprites/units/mc/jester/jester_attack_cut_400.png", {
        frameWidth: 400,
        frameHeight: 400,
    });
