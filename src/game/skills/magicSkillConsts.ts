...
import { IMAGE_SKILL_BURN, IMAGE_SKILL_DRAGON_FIRE, IMAGE_SKILL_LIGHTNING, IMAGE_SKILL_SHOCK_HAND, IMAGE_SKILL_YELLOW_EXPLOSION } from "../utils/load/skillImagesLoad";
