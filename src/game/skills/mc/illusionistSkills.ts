...
import { buffBaSelf } from "../bardSkillConsts";
import { magicAttack } from "../magicSkillConsts";
...
export const illusionistSkills: THeroSkills = [illusionistSkill, magicAttack, buffBaSelf];
