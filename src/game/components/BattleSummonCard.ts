...
export class BattleSummonCard extends Phaser.GameObjects.Container {
    ...
    async playAttack(value: number, skill?: IHeroSkill) {
        console.log("SUMMON PLAY ATTACK", value, skill);
        ...
        //
        if (attackAnimation) {
            if (!this.unitImageObject.anims) {
                console.log("ERROR! no this.unitImageObject", attackAnimation, this.unitImageObject.anims);
                return;
            }
