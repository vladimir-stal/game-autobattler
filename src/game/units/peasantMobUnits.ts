import { EHeroAttackType, EHeroClass, ETargetType, EUnitType, IUnit } from "../../types";
...
export const peasantUnit_4: IUnit = {
    ...
    id: PEASANT_ID,
    skills: [chainToNextSkill, peasantsStronkSkill, mobNoSkill, mobNoSkill],
    items: [],
    level: 4,
    exp: 0,
    mobItems: [
...
export const peasantUnit: IUnit = {
    ...
    name: i18n.units.PEASANT,
    id: PEASANT_ID,
    skills: [mobNoSkill, peasantLastStandSkill, chainToNextSkill, mobNoSkill],
    items: [],
    level: 1,
    exp: 0,
    mobItems: [
