...
export const skeletonUnit: IUnit = {
    ...
    id: "SKELETON",
    skills: [mobNoSkill, skeletonUnholyLeap, chainToNextSkill, mobNoSkill],
...
export const skeletonWarriorUnit: IUnit = {
    ...
    id: "SKELETONWARRIOR",
    skills: [chainToNextSkill, skeletonArmorSelfAndLow, mobNoSkill, mobNoSkill],
    items: [],
    level: 3,
    exp: 0,
    mobItems: [
...
export const skeletonMageUnit: IUnit = {
    ...
    id: "SKELETONMAGE",
    skills: [mobNoSkill, skeletonPoisonedFlames, chainToNextSkill, mobNoSkill],
    items: [],
    level: 3,
    exp: 0,
    mobItems: [
