...
export const warriorSummonMob_3: IUnit = {
    ...
    name: i18n.units.WARRIORSUMMON,
    id: "SPIRITWARRIOR3",
    skills: [chainToNextSkill, spiritTeamFlurry, mobNoSkill, mobNoSkill],
    items: [],
    level: 3,
    exp: 0,
    mobItems: [
...
export const warriorSummonMob: IUnit = {
    ...
    name: i18n.units.WARRIORSUMMON,
    id: "SPIRITWARRIOR",
    skills: [mobNoSkill, spiritTeamFlurry, chainToNextSkill, mobNoSkill],
    items: [],
    level: 1,
    exp: 0,
    mobItems: [
...
export const shieldWarriorsSummonMob: IUnit = {
    ...
    skills: [chainToNextSkill, spiritShieldRadiate, mobNoSkill, mobNoSkill],
...
export const fireflySummonMob: IUnit = {
    ...
    id: "FIREFLY",
    skills: [mobNoSkill, fireflyConfusingMistSkill, chainToNextSkill, mobNoSkill],
    items: [],
    level: 1,
    exp: 0,
    mobItems: [
...
export const fireflySummonMob_6: IUnit = {
    ...
    name: i18n.units.FIREFLY,
    id: "FIREFLY",
    skills: [mobNoSkill, fireflyUnfairExchange, chainToNextSkill, mobNoSkill],
    items: [],
    level: 6,
    exp: 0,
