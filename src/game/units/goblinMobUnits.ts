...
export const weakGoblinUnit: IUnit = {
    ...
    id: "WEAKGOBLIN",
    skills: [mobNoSkill, goblinPocketSand, chainToNextSkill, mobNoSkill],
    items: [],
    level: 1,
    exp: 0,
    mobItems: [
...
export const goblinUnit: IUnit = {
    ...
    id: "GOBLIN",
    skills: [chainToNextSkill, goblinApplyShock, mobNoSkill, mobNoSkill],
    items: [],
    level: 2,
    exp: 0,
    mobItems: [
...
export const goblinShamanUnit: IUnit = {
    ...
    id: "GOBLINSHAMAN",
    skills: [chainToNextSkill, goblinShamanHpRegIncr, mobNoSkill, mobNoSkill],
    items: [],
    level: 2,
    exp: 0,
    mobItems: [
...
export const goldGoblin1Unit: IUnit = {
    ...
    id: "GOLDGOBLIN1",
    skills: [chainToNextSkill,mobNoSkill,mobNoSkill,mobNoSkill],
    items: [],
    level: 3,
    exp: 0,
