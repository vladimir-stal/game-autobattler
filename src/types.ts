...
export enum AnimationType {
    ...
    // DOOMSAYER
    DOOMSAYER_IDLE = "DOOMSAYER_IDLE",
    DOOMSAYER_BATTLE_IDLE = "DOOMSAYER_BATTLE_IDLE",
    DOOMSAYER_ATTACK = "DOOMSAYER_ATTACK",
    DOOMSAYER_SKILL = "DOOMSAYER_SKILL",
    // HUNTER
    HUNTER_IDLE = "HUNTER_IDLE",
    HUNTER_BATTLE_IDLE = "HUNTER_BATTLE_IDLE",
    HUNTER_ATTACK = "HUNTER_ATTACK",
    // INQUISITOR
    INQUISITOR_IDLE = "INQUISITOR_IDLE",
    INQUISITOR_BATTLE_IDLE = "INQUISITOR_BATTLE_IDLE",
    INQUISITOR_ATTACK = "INQUISITOR_ATTACK",
    // JESTER
    ...
    ORACLE_BATTLE_IDLE = "ORACLE_BATTLE_IDLE",
    ORACLE_ATTACK = "ORACLE_ATTACK",
    ORACLE_SKILL_1 = "ORACLE_SKILL_1",
    ORACLE_SKILL_2 = "ORACLE_SKILL_2",
    // PALADIN
    ...
    //
    MOB_SKELETON_MAGE_BATTLE_IDLE = "MOB_SKELETON_MAGE_BATTLE_IDLE",
    MOB_SKELETON_MAGE_ATTACK = "MOB_SKELETON_MAGE_ATTACK",
    //
    ...
    //
    MOB_SUMMONKSHIELDNIGHT_BATTLE_IDLE = "MOB_SUMMONKSHIELDNIGHT_BATTLE_IDLE",
    MOB_SUMMONKSHIELDNIGHT_BUFF = "MOB_SUMMONKSHIELDNIGHT_BUFF",
    MOB_SUMMONKSHIELDNIGHT_HURT = "MOB_SUMMONKSHIELDNIGHT_HURT",
    //
...
export enum ESkillCondition {
    ...
    HAS_ALLY_IN_FRONT = "HAS_ALLY_IN_FRONT",
